"""
Django settings for testagshv_1 project.
...
WSGI_APPLICATION = 'testagshv_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testagshv_1 API",
    "DESCRIPTION": "API documentation for testagshv_1 App",
    "VERSION": "v1",
}
